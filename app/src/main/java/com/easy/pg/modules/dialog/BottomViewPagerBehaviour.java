...
public class BottomViewPagerBehaviour<V extends View> extends CoordinatorLayout.Behavior<V>  {
    ...
    public BottomViewPagerBehaviour() {
    }


    public BottomViewPagerBehaviour(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private View findScrollingChild(View view) {
        ...
        if (view instanceof ViewPager) {
            ...
            View currentViewPagerChild = viewPager.getFocusedChild();//ViewPagerUtils.getCurrentView(viewPager);
    ...
    public static <V extends View> BottomViewPagerBehaviour<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof BottomViewPagerBehaviour)) {
            throw new IllegalArgumentException(
                    "The view is not associated with ViewPagerBottomSheetBehavior");
        }
        return (BottomViewPagerBehaviour<V>) behavior;
    }
}
