...
public class DialogUtils {
    ...
    private static class BottomSheetViewPagerListener extends ViewPager.SimpleOnPageChangeListener {
        ...
        private final BottomViewPagerBehaviour<View> behavior;

        private BottomSheetViewPagerListener(ViewPager viewPager, View bottomSheetParent) {
            this.viewPager = viewPager;
            this.behavior = BottomViewPagerBehaviour.from(bottomSheetParent);
        }
    ...
    private static View findBottomSheetParent(final View view) {
        ...
        while (current != null) {
            ...
            if (params instanceof CoordinatorLayout.LayoutParams && ((CoordinatorLayout.LayoutParams) params).getBehavior() instanceof BottomViewPagerBehaviour) {
                return current;
            }
